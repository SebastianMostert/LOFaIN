...
export default function Footer() {
  return (
    <footer className="site-footer border-t border-stone-800 bg-stone-950 py-8">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 text-sm text-stone-400 sm:flex-row sm:items-center sm:justify-between">
        <p>League of Free and Independent Nations archive and proceedings portal.</p>
        <div className="flex items-center gap-4">
          ...
          <Link href="/api/docs" className="transition hover:text-stone-200">
            API
          </Link>
        </div>
      </div>
