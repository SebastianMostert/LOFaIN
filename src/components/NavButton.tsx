...
export default function NavButton({ href, label }: { href: string; label: string; }) {
    ...
    return (
        <Link
            href={href}
            className="rounded-full px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-white transition-transform active:translate-y-0.5 sm:px-4 sm:text-sm sm:tracking-[0.2em]"
            style={{
                background: active
